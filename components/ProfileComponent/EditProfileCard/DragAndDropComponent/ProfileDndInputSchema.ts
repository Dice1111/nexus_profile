...
export const profileDndInputSchema = z.discriminatedUnion("type", [
  ...
  baseComponentSchema.extend({
    ...
    display_text: z.string().optional(),
    value: z.string()
      .regex(/^https:\/\/t\.me\/[a-zA-Z0-9_]{1,32}$/, "Telegram username must be in the format: https://t.me/{username} (1-32 characters, alphanumeric or underscores)"),
  }),
  ...
  baseComponentSchema.extend({
    ...
    value: z.string()
      ...
      .refine((url) => /^https:\/\/www\.instagram\.com\//.test(url), {
        message: "Instagram URL must be in the format: https://www.instagram.com/p/{postId}/",
      }),
  }),
