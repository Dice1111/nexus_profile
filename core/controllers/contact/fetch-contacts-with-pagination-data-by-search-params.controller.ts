import { IFetchContactsWithSpecificCardDataBySearchParamsUseCase } from "@/core/application/use-cases/contact/fetch-contacts-with-specific-card-data-by-search-params.use-case";
import { IFetchTotalContactCountBySearchParamsUseCase } from "@/core/application/use-cases/contact/fetch-total-contact-count-by-search-params.use-case";
