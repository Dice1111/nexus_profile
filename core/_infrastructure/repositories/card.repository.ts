...
export class CardRepository implements ICardRepository {
    ...
    async fetchWithInformationAndDesignByUserID(userID: string): Promise<IFetchCardWithInformationAndDesignData[]> {
        ...
        try{
            ...
            throw new DatabaseOperationError("Failed to fetch cards", { cause: error });
        }
    }
}
