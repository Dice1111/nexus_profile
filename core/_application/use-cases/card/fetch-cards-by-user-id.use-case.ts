...
import { ICardWithTitleAndID } from "@/core/_domain/repositories/types/card.types";
import { IAuthenticationService } from "@/core/_domain/services/IAuthentication.service";


export const fetchCardsTitleAndNameUseCaseByUserId = (cardRepository: ICardRepository, authenticationService: IAuthenticationService) => async (): Promise<ICardWithTitleAndID[]> => {
